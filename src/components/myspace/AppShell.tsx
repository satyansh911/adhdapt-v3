...
const NAV: NavItem[] = [
  ...
  { href: "/community", label: "Community", short: "Chat", img: "/home/community.png" },
];
...
// Mobile bottom tab bar: Home, Games, Mood, Tasks, Community.
const MOBILE_TABS = ["/dashboard", "/game", "/mood", "/tasks", "/community"];
...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#080808] text-[#ececf0]">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around border-t-2 border-[#111] bg-[#141414] px-2 py-2.5 md:hidden">
