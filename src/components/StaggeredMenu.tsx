...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-40 pointer-events-none ${isFixed ? 'fixed inset-0 overflow-hidden' : 'w-full h-full'}`}
    >
      <div
        className={
      ...
      >
        ...
        <header
          className={`staggered-menu-header ${isFixed ? 'fixed' : 'absolute'} top-0 left-0 w-full flex items-center justify-between px-[2em] py-4 pointer-events-none z-20 transition-colors duration-300`}
        ...
        >
          <a href="/" className="sm-logo flex items-center gap-3 select-none pointer-events-auto" aria-label="ADHDapt home">
            <img
