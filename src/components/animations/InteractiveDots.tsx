...
export const InteractiveDots: React.FC = () => {
   ...
   const DOT_SPACING = 30; // Spaced out for tech vibe
       ...
       for (let i = 0; i < cols; i++) {
           for (let j = 0; j < rows; j++) {
               ...
               newDots.push({
                   x,
                   y,
                   // Electric Blue base color -> rgba(0, 163, 255)
                   baseColor: `rgba(0, 163, 255, ${BASE_OPACITY_MAX})`,
   ...
   const animateDots = useCallback(() => {
       ...
       dots.forEach((dot, index) => {
           ...
           // Using pure electric blue for INK games vibe
           ctx.beginPath();
           ctx.fillStyle = `rgba(0, 163, 255, ${finalOpacity.toFixed(3)})`;
