...
export function TileMemoryGame({ onBack, sidebarOpen = true }: TileMemoryGameProps) {
  ...
  const getTileImage = (imageId: number) => {
    const tileDesigns = [
      { bg: "bg-red-500", icon: <LottieSafeWrapper src="/tile-photos/honeycomb.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-red-200" },
      { bg: "bg-blue-500", icon: <LottieSafeWrapper src="/tile-photos/clock.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-blue-200" },
      { bg: "bg-green-500", icon: <LottieSafeWrapper src="/tile-photos/home.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-green-200" },
      { bg: "bg-yellow-500", icon: <LottieSafeWrapper src="/tile-photos/gift.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-yellow-200" },
      { bg: "bg-purple-500", icon: <LottieSafeWrapper src="/tile-photos/camera.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-purple-200" },
      { bg: "bg-pink-500", icon: <LottieSafeWrapper src="/tile-photos/globe.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-pink-200" },
      { bg: "bg-indigo-500", icon: <LottieSafeWrapper src="/tile-photos/edit.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-indigo-200" },
      { bg: "bg-orange-500", icon: <LottieSafeWrapper src="/tile-photos/computer.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-orange-200" },
      { bg: "bg-teal-500", icon: <LottieSafeWrapper src="/tile-photos/heart.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-teal-200" },
      { bg: "bg-cyan-500", icon: <LottieSafeWrapper src="/tile-photos/chart.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-cyan-200" },
      { bg: "bg-lime-500", icon: <LottieSafeWrapper src="/tile-photos/star.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-lime-200" },
      { bg: "bg-amber-500", icon: <LottieSafeWrapper src="/tile-photos/photo.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-amber-200" },
      { bg: "bg-emerald-500", icon: <LottieSafeWrapper src="/tile-photos/coin.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-emerald-200" },
      { bg: "bg-violet-500", icon: <LottieSafeWrapper src="/tile-photos/man.json" size={50} autoplay={true} loop={false} fallbackIcon="🔍"/>, shadow: "shadow-violet-200" },
      ...
      <Dialog open={showCompletionDialog} onOpenChange={setShowCompletionDialog}>
        <DialogContent className="sm:max-w-md rounded-3xl bg-[#fdedc9] text-black">
          ...
          <div className="text-center space-y-4">
            <div className="text-6xl animate-bounce"><LottieSafeWrapper src="/confetti.json" size={80} autoplay={true} loop={false} fallbackIcon="🔍"/></div>
